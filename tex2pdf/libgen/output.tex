...
\global\headline={\begingroup\header\hss\the\rrunninghead\hss\llap{\the\pageno}\endgroup}
\endgroup}
\def\evensetup{
\advance\hoffset by \outermargin
\headline={\begingroup\header\rlap{\the\pageno}\hss\the\lrunninghead\hss\endgroup}
}
...
\def\headerthispage{\global\noheaderthispagefalse}
