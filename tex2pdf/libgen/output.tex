...
\def\pagesetup{\hoffset=-1in \voffset=-1in \vbadness=2000
	...
	\ifnoheaderthispage
		\global\noheaderthispagefalse\headline={}\fi}
...
\newif\ifsamepage
\def\puttranslationins{
	\ifvoid\translationins\else
		\ifsamepage\global\samepagefalse\else\global\samepagetrue
			\rlap{\vbox to 0pt{\hbox to \textwidth{\hfil\box\translationins}}}\fi\fi}
