\long\def\begindoublecolumns#1\enddoublecolumns{\begingroup
	\updatefreespace
	\doublecolumnsetup
	\storecontent{#1\vskip 0pt plus 1sp}
	\ifbalancecolumns
...
\def\pagesofar{
	\dimen0=\maxdim(\ht0, \ht2) \dimen1=\maxdim(\dp0, \dp2)
	\ifdim\dimen0>0pt
		\setbox0=\vtop to \dimen0{\unvbox0} \setbox2=\vtop to \dimen0{\unvbox2} \wd0=\hsize \wd2=\hsize
