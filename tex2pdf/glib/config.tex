...
\grechangedim{beforealterationspace}{.25cm}{fixed}

\gresetclivisalignment{never}

\grechangestyle{modeline}{\scshape\spaceskip=.7ex}
\grechangestyle{annotation}{\decorativ\fontsize{10pt}{0pt}\selectfont\spaceskip=.7ex}
\grechangestyle{abovelinestext}{\courant\fontsize{9pt}{0pt}\selectfont}
